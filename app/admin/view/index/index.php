...
<div class="layui-layout layui-layout-admin">
    ...
    <!-- 底部 -->
    <div class="layui-footer layui-text">copyright © 2023 <a href="https://www.veitool.com" target="_blank">veitool.com</a> all rights reserved.<span class="pull-right">Version {:VT_VERSION}</span></div>
</div>
<!-- 加载动画 -->
