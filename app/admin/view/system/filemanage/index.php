            ...
            <form class="layui-form" lay-filter="filemanage-form-search">
                <div class="layui-form-item" style="margin-bottom:5px;">
                    ...
                    <div class="layui-inline" style="margin-right:0;">
                        <div class="layui-input-inline" style="width:172px;"><input type="text" name="sotime" id="filemanage-search-time" placeholder="上传时间" autocomplete="off" class="layui-input"></div>
                    </div>
