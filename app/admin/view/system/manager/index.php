                    ...
                    <form class="layui-form" lay-filter="manager-form-search">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline" style="margin-right:0;">
                                <div class="layui-input-inline" style="width:172px;"><input type="text" name="sotime" id="manager-search-time" placeholder="登录时间" autocomplete="off" class="layui-input"></div>
                            </div>
            ...
            success: function(l,index){
                layui.buildItems.build({
                    ...
                    data: [
                        ...
                        {name:"password",title:"登录密码",type:"password",tid:'m_pwd',value:'',verify:'pass',placeholder:"请输入6-16位登录密码",must:true},
                        {name:"repassword",title:"确认密码",type:"password",tid:'m_repwd',value:'',verify:'repass',placeholder:"请重复登录密码",must:true},
