tinymce.PluginManager.add('vimgs',function(editor,url){
	...
	editor.ui.registry.addMenuItem('vimgs',{
		icon: 'vimgs',
		text: pluginName,
		onAction: function(){
			openDialog();
